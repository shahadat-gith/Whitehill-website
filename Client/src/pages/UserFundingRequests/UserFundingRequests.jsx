...
const UserFundingRequests = () => {
  ...
  const getStatusConfig = (status) => {
    const config = {
      draft: { class: "ufr-status-pending", label: "Draft", icon: "fa-pen" },
      submitted: { class: "ufr-status-pending", label: "Submitted", icon: "fa-paper-plane" },
      ...
      funded: { class: "ufr-status-approved", label: "Funded", icon: "fa-sack-dollar" },
  ...
  if (loading)
    return (<div className="ufr-loading-screen"> <div className="ufr-loader"></div> <p>Loading funding status...</p> </div>
    );

  if (error)
    return (<div className="ufr-error"> <p>{error}</p> </div>
    );
  ...
  return (
    <div className="ufr-page">
      <div className="ufr-header-simple">
        ...
        <p className="ufr-subtitle">
          Monitor your funding lifecycle and active disbursements.
        </p>
      </div>
      ...
      <div className="ufr-list-container">
        {fundingRequests.length === 0 ? (
          ...
          fundingRequests.map((request) => {
            ...
            const isPaid = request.payment !== null;
                  ...
                  {(request.status === "approved") && (
                    <div className="ufr-approval-panel">
                      <div className="ufr-approval-stat">
                        ...
                        <span className="ufr-approved-amt">
                      ...
                      <div className="ufr-approval-actions">
                        <button
                          ...
                          onClick={() =>
                            isPaid && handleDownloadInvoice(request._id)
                          }
                        ...
                        >
                          ...
                          <span>
                            {!isPaid ? "Yet to disburse" : "Download Invoice"}
                          </span>
                        </button>
                      </div>
                    </div>
                  ...
                  {request.status === "under_review" &&
                    !request.pendingRequests?.length && (
                      <div className="ufr-info-msg">
                        ...
                        <span>
                          Your application is being verified by our compliance team.
                        </span>
                      </div>
                    )}
                        ...
                        {request.pendingRequests?.map((req) => (
                          <div key={req._id} className="ufr-doc-alert">
                            <div className="ufr-doc-info">
                              ...
                              <p>
                                <strong>Compliance Action:</strong> {req.message}
                              </p>
                            </div>
                            <button
